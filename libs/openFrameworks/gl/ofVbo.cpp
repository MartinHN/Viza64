...
void ofVbo::updateOneVertexData(const ofVec3f * vert, int idx) {
	positionAttribute.updateData(idx*positionAttribute.stride, positionAttribute.stride, &vert[0].x);
}
...
void ofVbo::updateOneColorData(const ofFloatColor * color, int idx) {
	colorAttribute.updateData(idx*colorAttribute.stride, colorAttribute.stride, &color[0].r);
}
